...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactTimerMixin = __webpack_require__(1);
	...
	var ReportUI = React.createClass({
	    ...
	    loadWeatherByCity: function loadWeatherByCity(city) {
	    ...
	    loadWeatherByLocation: function loadWeatherByLocation() {
	        var city;
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                null,
	                ' ',
	                this.state.location.localtime,
	                ' '
	            ),
	            React.createElement(
	                'div',
	                { 'class': 'row margin' },
	                React.createElement('input', { className: 'col-xs-4 noPadding reportButton', type: 'button', value: 'Previous day' }),
	                React.createElement('input', { className: 'col-xs-4 noPadding reportButton', type: 'button', value: 'Next day' }),
	                React.createElement('input', { className: 'col-xs-4 noPadding reportButton', type: 'button', value: 'Calendar' })
	            ),
	            React.createElement(
	                'p',
	                { className: 'temp' },
	            ...
	            React.createElement(
	                ...
	                null,
	                ' Wind direction ',
	                this.state.weather.wind_dir
	            ),
	            React.createElement(
	                'p',
	                null,
	                ' Wind speed ',
	                this.state.weather.wind_kph,
	                ' '
	            ),
	            React.createElement(
	                'p',
	...
	ReactDOM.render(React.createElement(ReportUI, null), document.getElementById('reportUI'));
